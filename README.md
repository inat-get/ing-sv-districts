...
Скрипты статистики ([inat-get](https://github.com/inat-get/inat-get)) 
для [районов Свердловской области](https://www.inaturalist.org/projects/bioraznoobrazie-rayonov-sverdlovskoy-oblasti).
...
+ Скрипты выдаеют результат формально в формате Markdown, но в действительности это упрощенный HTML специально для постов
